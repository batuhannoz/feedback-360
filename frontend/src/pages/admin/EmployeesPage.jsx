...
const EmployeesPage = () => {
    ...
    const updateSelectedEmployeesStatus = (isActive) => {
        const promises = selectedEmployees.map(id => {
            ...
            if (employee) {
                const userRequest = { ...employee, isActive };
    ...
    const handleExportClick = () => {
        console.log("Dışa aktarma işlemi başlatıldı.");
        if (selectedEmployees.length > 0) {
            console.log(`${selectedEmployees.length} seçili çalışan dışa aktarılıyor.`);
        } else {
            console.log("Tüm çalışanlar dışa aktarılıyor.");
        }
        alert("Dışa aktarma işlemi konsola yazdırıldı.");
    };
        ...
        <div className="container mx-auto p-4">
            ...
            <div className="bg-white p-4 rounded-lg shadow">
                <div className="flex flex-col md:flex-row gap-4 mb-4">
                    <Input
                        placeholder="İsim veya soyisime göre ara..."
                        value={filters.name}
                ...
                <div className="flex items-center gap-2 mb-4">
                    <Button size="sm" onClick={() => updateSelectedEmployeesStatus(false)} disabled={selectedEmployees.length === 0}>
                        Seçilenleri Pasif Yap
                    </Button>
                    <Button size="sm" onClick={() => updateSelectedEmployeesStatus(true)} disabled={selectedEmployees.length === 0}>
